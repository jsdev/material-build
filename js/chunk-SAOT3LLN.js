...
var Field = class extends s {
  ...
  renderLabel(isFloating) {
    ...
    return x`
      <span class="label ${o2(classes)}" aria-hidden=${!visible}
        >${labelText}</span
      >
    `;
  }
...
MdOutlinedField.styles = [styles2, styles3];
 ...
 * SPDX-License-Identifier: Apache-2.0
 */
//# sourceMappingURL=chunk-SAOT3LLN.js.map
